...
public class HttpClientUtil { 
    public static void main(String[] args)throws Exception{ 
        ...
        params.put("username", "liqiang.zhang@ecloud.com.cn"); 
        params.put("password", "1qazXSW@"); 
        ...
        sendSSLPostRequest("https://mail.ecloud.com.cn/owa/auth/logon.aspx?replaceCurrent=1", params); 
    } 
